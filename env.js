 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.ecomerce.staging
 */

const BUNDLE_ID = 'com.ecomerce'; // ios bundle id
const PACKAGE = 'com.ecomerce'; // android package name
const NAME = 'Ecomerce'; // app name
